...
public class ReviewsService {
    ...
    private Reviews documentSnapshotToReviews(DocumentSnapshot document)
    {
        ...
        if(document.exists()){
            reviews = new Reviews(document.getId(),document.getString("hotelID"),document.getString("userID"),document.getDouble("rating"),document.getString("comment"), document.getTimestamp("date").toProto());
        }
        return reviews;
    }
